...
from .views import article_category_detail, article_detail, latest_articles, create_article, create_article_category, create_tag, delete_article, delete_tag, featured_articles, get_category_tag, popular_articles, retrive_articles, retrive_articles_author, update_article, update_article_category, update_tag

urlpatterns = [
    path('create-article-category/', create_article_category,
         name='create_article_category'),
    path('update-article-category/<int:category_id>/',
         update_article_category, name='update_article_category'),
    path('delete-article-category/<int:category_id>/',
         delete_article, name='delete_articles'),
    path('article-category-tags/', get_category_tag,
         name='get_article_category_and_tags'),
    path('article-category/<str:slug>/', article_category_detail,
         name='article_category_details'),
